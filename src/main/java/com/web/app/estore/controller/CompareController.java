...
import com.web.app.estore.exception.ResourceNotFoundException;
import com.web.app.estore.model.Compare;
import com.web.app.estore.repository.CompareRepository;
...
public class CompareController {
	...
	public List<Compare> getAllProducts() {
		return (List<Compare>) crepo.findAll(); 
	}
